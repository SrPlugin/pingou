...
**Pingou** es el Asistente de [Programadores y Estudiantes](https://discord.gg/programacion). Este bot se encarga de multiples tareas para mejorar la experiencia de los usuarios.

## Contribuir

¡Las contribuciones son bienvenidas! Si quieres ayudar a mejorar el bot de nuestra comunidad, revisa nuestra [Guía de Contribución](./CONTRIBUTING.md).
